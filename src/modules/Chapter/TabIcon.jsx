...
const paths = {
  ...
  QUIZ: [
    'M8.6 36.6V43H15l19-19-6.5-6.3zM39 19c.6-.6.6-1.7 0-2.4l-4-4c-.7-.6-1.8-.6-2.4 0L29.3 16l6.4 6.4z',
    'M18.8 21h2.8V18h-2.8zM16 10.1l1.2 1.2c1 1 1.6 1.9 1.6 4h2.8v-.7c0-1.6-.6-3-1.6-4L18.3 9a2.8 2.8 0 0 1 2-4.8C21.7 4.2 23 5.5 23 7h2.8a5.6 5.6 0 1 0-11.1 0c0 1.2.5 2.3 1.3 3.2z',
  ],
}
