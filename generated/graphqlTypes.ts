...
export type TSortOrderEnum = 'ASC' | 'DESC'
...
export type TMadrassahPageQueryQuery = {
  api: {
    tracks: Array<
      Pick<TApi_Tracks, 'id' | 'slug'> & {
        translations: Array<Pick<TApi_Track_Translations, 'id' | 'locale_code' | 'title'>>
        courses: Array<
          Pick<TApi_Courses, 'id' | 'slug'> & {
            quiz_difficulties: Maybe<Pick<TApi_Course_Quiz_Difficulties, 'quiz_difficulties'>>
            translations: Array<Pick<TApi_Course_Translations, 'id' | 'locale_code' | 'title'>>
            chapters: Array<
...
export type TAboutUsTranslationsFragment = Pick<
  TTranslationsJson,
  | 'aboutUs'
  | 'aboutUsPageTitle'
  | 'aboutUsPageContent'
...
export type TAboutUsQueryQuery = {
  api: { tracks: Array<TAboutUsTrackFragment> }
  translations: Maybe<TAboutUsTranslationsFragment>
  otherLocaleTranslations: Maybe<TAboutUsOtherTranslationFragment>
}

export type TChapterPageTrackFragment = Pick<TApi_Tracks, 'id' | 'slug'> & {
  translations: Array<Pick<TApi_Track_Translations, 'title'>>
  courses: Array<
    Pick<TApi_Courses, 'id' | 'slug'> & {
      quiz_difficulties: Maybe<Pick<TApi_Course_Quiz_Difficulties, 'quiz_difficulties'>>
      chapters: Array<
        Pick<TApi_Chapters, 'id' | 'slug'> & { translations: Array<Pick<TApi_Chapter_Translations, 'title'>> }
      >
...
export type TChapterPageTranslationsFragment = Pick<
  TTranslationsJson,
  | 'chapter'
  | 'clickHere'
  | 'chapterAudio'
...
export type TChapterQueryQuery = {
  api: {
    chapter: Maybe<
      Pick<TApi_Chapters, 'id' | 'slug' | 'audio'> & {
        translations: Array<
          Pick<TApi_Chapter_Translations, 'id' | 'title' | 'transcription' | 'vocabulary' | 'locale_code' | 'video'>
        >
        course: Pick<TApi_Courses, 'id' | 'slug'> & {
  ...
  translations: Maybe<TChapterPageTranslationsFragment>
  otherLocaleTranslations: Maybe<Pick<TTranslationsJson, 'localeName' | 'localePath' | 'readIn'>>
}

export type THomeTrackFragment = Pick<TApi_Tracks, 'id' | 'order' | 'slug' | 'soon'> & {
...
export type TQuizzesPageQuizFragment = Pick<TApi_Quizzes, 'id' | 'type_slug'> & {
  translations: Array<Pick<TApi_Quiz_Translations, 'id' | 'data'>>
}

export type TQuizzesPageTranslationsFragment = Pick<
  TTranslationsJson,
  | 'assessmentPerfect'
  | 'assessmentVeryGood'
  | 'assessmentGood'
...
export type TQuizQueryQuery = {
  api: {
    course: Maybe<
      Pick<TApi_Courses, 'id' | 'slug'> & {
        translations: Array<Pick<TApi_Course_Translations, 'id' | 'title'>>
        quizzes: Array<TQuizzesPageQuizFragment>
        track: Pick<TApi_Tracks, 'id' | 'slug'> & {
          translations: Array<Pick<TApi_Track_Translations, 'title'>>
          courses: Array<
            Pick<TApi_Courses, 'id' | 'slug'> & {
              quiz_difficulties: Maybe<Pick<TApi_Course_Quiz_Difficulties, 'quiz_difficulties'>>
  ...
  translations: Maybe<TQuizzesPageTranslationsFragment>
  otherLocaleTranslations: Maybe<Pick<TTranslationsJson, 'localeName' | 'localePath'>>
}

export type TTrackPageCourseFragment = Pick<TApi_Courses, 'id' | 'level' | 'slug'> & {
  translations: Array<Pick<TApi_Course_Translations, 'title' | 'description'>>
  chapters: Array<
  ...
  >
  quiz_difficulties: Maybe<Pick<TApi_Course_Quiz_Difficulties, 'quiz_difficulties'>>
  topic: Pick<TApi_Topics, 'id' | 'color'> & { translations: Array<Pick<TApi_Topic_Translations, 'title'>> }
}

export type TTrackPageTranslationsFragment = Pick<
  TTranslationsJson,
  | 'connect'
  | 'course'
  | 'level1'
...
export type TTrackQueryQuery = {
  api: {
    track: Maybe<
      Pick<TApi_Tracks, 'id' | 'slug'> & {
        translations: Array<Pick<TApi_Track_Translations, 'title'>>
        courses: Array<TTrackPageCourseFragment>
      }
    >
  }
  translations: Maybe<TTrackPageTranslationsFragment>
  otherLocaleTranslations: Maybe<Pick<TTranslationsJson, 'localeName' | 'localePath'>>
}

export type TTracksPageTranslationsFragment = Pick<
  TTranslationsJson,
  | 'aboutUs'
  | 'connect'
  | 'copyright'
...
export type TTracksPageTrackFragment = Pick<TApi_Tracks, 'id' | 'slug' | 'soon'> & {
...
export type TTracksQueryQuery = {
  translations: Maybe<TTracksPageTranslationsFragment>
  otherLocaleTranslations: Maybe<TTracksPageOtherTranslationsFragment>
  api: { tracks: Array<TTracksPageTrackFragment> }
}
