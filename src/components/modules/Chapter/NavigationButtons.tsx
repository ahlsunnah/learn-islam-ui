...
const NavigationButtons = ({ isChapterComplete, next: { path, title, type }, t, toggleCompleteChapter }: IProps) =>
  path ? (
    <div className="mt2 mb4 ph2 ph4-ns">
      <h1 className="mb2">{type === 'tracks' ? t.next : `${t.locale === 'ar' ? 'ال' : ''}${t[type]} ${t.next}`}</h1>
